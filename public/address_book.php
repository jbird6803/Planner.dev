...
function removeContact($addressBook, $filename = './csv/address_book.csv') {
...
if(isset($_GET['id'])) {
	removeContact($addressBook, $filename);
}
...
<div class="container">
	...
	<form method="POST" action="/address_book.php" role="form" class="form">
